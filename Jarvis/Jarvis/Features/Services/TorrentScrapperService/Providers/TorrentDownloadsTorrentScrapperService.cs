...
public class TorrentDownloadsTorrentScrapperService : TorrentScrapperServiceBase
{
    public override bool IsActive => true;
    public override string Name => "TorrentDownloads";

    public TorrentDownloadsTorrentScrapperService(
        string url)
        : base(url)
    {
    }
        ...
        string query)
    {
        ...
        var content = await httpService.GetStringAsync($"/search/?search={query}");
